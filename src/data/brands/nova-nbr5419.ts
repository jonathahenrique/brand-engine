...
export const novaNbr5419: BrandConfig = {
  ...
  shape: {
    ...
    radiusMd: '10px',
    radiusLg: '16px',
    shadowElevated: '0 4px 24px rgba(10,22,40,0.18)',
    shadowModal: '0 16px 64px rgba(3,9,18,0.8)',
    borderWidth: '1px',
  },
  ...
  theme: {
    ...
    secondary: '#0A1628',
    secondaryHover: '#112240',
    secondaryDeep: '#060D1A',
    secondaryMuted: 'rgba(10,22,40,0.12)',
    text: '#F5F5F5',
    textSecondary: '#8B9BB5',
    textTertiary: '#5A6A82',
    border: 'rgba(10,22,40,0.22)',
    borderSubtle: 'rgba(10,22,40,0.10)',
  },

  colors: {
    philosophy:
      'Âmbar como o flash do raio — luminoso, fugaz, poderoso. Navy como a autoridade técnica — profundo, sólido, confiável. Juntos evocam precisão normativa e excelência profissional: o padrão que a NBR 5419:2026 exige.',
    dark: [
      { token: 'bg-deep', name: 'Navy Profundo', hex: '#030912', usage: 'Background principal' },
      { token: 'bg-surface', name: 'Navy Superfície', hex: '#0A1628', usage: 'Cards, superfícies' },
      { token: 'bg-elevated', name: 'Navy Elevado', hex: '#112240', usage: 'Hover de card, dropdowns' },
      ...
      { token: 'navy-primary', name: 'Navy 900', hex: '#0A1628', usage: 'Secondary actions, tags, accents' },
      { token: 'navy-hover', name: 'Navy 800', hex: '#112240', usage: 'Hover do navy' },
      { token: 'navy-deep', name: 'Navy 950', hex: '#060D1A', usage: 'Pressed state, sombras coloridas' },
      { token: 'text-primary', name: 'Branco Puro', hex: '#F5F5F5', usage: 'Texto principal' },
      { token: 'text-secondary', name: 'Cinza Azulado', hex: '#8B9BB5', usage: 'Texto secundário, metadados' },
      { token: 'text-tertiary', name: 'Cinza Escuro', hex: '#5A6A82', usage: 'Placeholders, texto desabilitado' },
    ],
    light: [
      { token: 'bg-light', name: 'Pedra Clara', hex: '#F8F9FC', usage: 'Background seções claras' },
      { token: 'surface-light', name: 'Pedra Suave', hex: '#EEF1F6', usage: 'Cards em seções claras' },
      { token: 'amber-light', name: 'Âmbar Contraste', hex: '#C8910E', usage: 'Primary em contexto claro' },
      { token: 'navy-light', name: 'Navy 900', hex: '#0A1628', usage: 'Secondary em contexto claro' },
      { token: 'text-light', name: 'Navy Escuro', hex: '#0A1628', usage: 'Texto em fundo claro' },
      { token: 'text-secondary-light', name: 'Navy Médio', hex: '#1A2D4A', usage: 'Texto secundário em fundo claro' },
      { token: 'border-light', name: 'Navy Sutil', hex: 'rgba(10,22,40,0.12)', usage: 'Bordas em fundo claro' },
    ],
    primaryUsage: {
      do: [
    ...
    secondaryUsage: {
      do: [
        'Cards e superfícies elevadas sobre background navy',
        'Tags de categoria e labels sobre fundo escuro',
        'Accents em gradientes sutis navy→transparent',
        'Bordas e separadores de seção',
      ],
      dont: [
        'CTA principal — navy não tem contraste suficiente como botão',
        'Texto corrido — usar tokens de texto (textSecondary, textTertiary)',
        'Background de áreas grandes sem sobreposição de conteúdo',
      ],
    },
  },
  ...
  textures: {
    ...
    grainOpacity: 0,
    overlays: [
      'linear-gradient(135deg, rgba(240,193,66,0.04) 0%, rgba(10,22,40,0.08) 100%) — cards',
    ],
  },
  ...
  logo: {
    ...
    rules: [
      ...
      'Cores permitidas: âmbar gradiente (padrão), all-white (sobre navy/escuro), all-dark #0A1628 (sobre âmbar)',
      'Sobre fundos claros: escudo âmbar + wordmark em #0A1628',
      'O ícone SPDA interno sempre branco ou #030912 — nunca recolorir',
    ],
    misuse: [
  ...
  photography: {
    style: 'Corporativo Moderno — adaptado com color grading âmbar/navy da paleta Alquimia Técnica',
    ...
    colorTreatment: 'Dark overlay rgba(3,9,18,0.4) + grade âmbar sutil — integra fotos reais à paleta',
    subjects: [
